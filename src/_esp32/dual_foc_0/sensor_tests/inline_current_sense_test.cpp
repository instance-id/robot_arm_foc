...
#if defined(RUN_CURRENT_SENSE) && RUN_CURRENT_SENSE == 1 && defined(FOC_CONTROLLER) && FOC_CONTROLLER == 24
...
// 电流检测
// 采样电阻值 增益 ADC引脚
InlineCurrentSense current_sense0 = InlineCurrentSense(0.01f, 50.0f, 15, 16);
