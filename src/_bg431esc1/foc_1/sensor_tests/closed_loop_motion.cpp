#if defined(RUN_CLOSED_LOOP) && RUN_CLOSED_LOOP == 1 && defined(FOC_CONTROLLER) && FOC_CONTROLLER == 23
...
void loop()
{
    ...
    if (millis() - printTimeMS > 500)
    {
        ...
        String msg = "Angle: " + String(motorAngle) + ", Sensor: " + String(sensorAngle) + ", Vbus: " + String(vbusV) + "V, Temp: " + String(tempDegC) + "°C" + ", Current: " + String(currentMagnitude) + "A";
        Serial.println(msg);
    }
